...
public class TweetServiceTest {
    ...
    private User user = new User(Role.USER, "user@mail.com", "user", "password");
    ...
    public void createTest() {
        ...
        Tweet tweet3 = new Tweet(message, new Date(1L), user);
        Tweet createdTweet3 = tweetService.create(tweet3);
        ...
        Tweet tweet4 = new Tweet(emptyMessage, new Date(1L), user);
        Tweet createdTweet4 = tweetService.create(tweet4);
